...
export const economyTree: Tech[] = [
    ...
    // ============================================
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_production_mult', value: 0.05, description: '+5% raw extraction' }],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_manufacturing_mult', value: 0.05, description: '+5% manufacturing output' }],
        prerequisites: [], researchCost: 50,
        seasonScoreTags: [SeasonScoreCategory.PRODUCTION],
        position: { x: 4, y: 0 },
        unlockFlags: [],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_production_mult', value: 0.03, description: '+3% raw extraction (less spoilage)' }],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_manufacturing_mult', value: 0.10, description: '+10% manufacturing output' }],
        prerequisites: [], researchCost: 50,
        seasonScoreTags: [SeasonScoreCategory.PRODUCTION],
        position: { x: 8, y: 0 },
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_upkeep_mult', value: -0.10, description: '-10% service upkeep' }],
        prerequisites: [], researchCost: 60,
        seasonScoreTags: [SeasonScoreCategory.WEALTH],
        position: { x: 12, y: 0 },
        unlockFlags: [],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_tax_mult', value: 0.05, description: '+5% tax revenue' }],
        prerequisites: [], researchCost: 50,
        seasonScoreTags: [SeasonScoreCategory.WEALTH],
        position: { x: 16, y: 0 },
        unlockFlags: [],
    ...
    // PATH A: INDUSTRIAL OUTPUT
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_production_mult', value: 0.15, description: '+15% raw extraction' }],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_production_mult', value: 0.10, description: '+10% raw extraction' }],
        prerequisites: ['eco_t2_ind_1'], researchCost: 180,
        seasonScoreTags: [SeasonScoreCategory.PRODUCTION],
        position: { x: 4, y: 3 },
        unlockFlags: [],
    ...
    // PATH B: TRADE & WEALTH
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_tax_mult', value: 0.10, description: '+10% tax revenue' }],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_tax_mult', value: 0.15, description: '+15% tax revenue' }],
    ...
    // PATH C: EFFICIENCY & SUSTAINABILITY
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_upkeep_mult', value: -0.20, description: '-20% service upkeep' }],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_PERCENT, modifierKey: 'eco_upkeep_mult', value: -0.15, description: '-15% service upkeep' }],
