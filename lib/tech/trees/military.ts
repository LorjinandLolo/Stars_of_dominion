...
export const militaryTree: Tech[] = [
    ...
    // ============================================
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_FLAT, modifierKey: 'orbital_power_multiplier', value: 0.10, description: '+10% orbital combat power' }],
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_FLAT, modifierKey: 'ground_power_multiplier', value: 0.05, description: '+5% ground combat power' }],
        prerequisites: [], researchCost: 50,
    ...
    },
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_FLAT, modifierKey: 'ground_power_multiplier', value: 0.20, description: '+20% ground combat power' }],
        prerequisites: ['mil_t2_ovr_1'], researchCost: 180,
        seasonScoreTags: [SeasonScoreCategory.MILITARY, SeasonScoreCategory.TERRITORY],
        position: { x: 4, y: 3 },
        unlockFlags: [],
    ...
    // ============================================
    {
        ...
        effects: [{ type: TechEffectType.MODIFIER_FLAT, modifierKey: 'prediction_bonus_add', value: 0.20, description: 'Correct stance prediction pays 35% instead of the base 15%' }],
