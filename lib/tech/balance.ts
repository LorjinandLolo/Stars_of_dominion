...
export const STAT_SHIFT_VALUES = {
    [Magnitude.VERY_LOW]: 0.05,  // 5%
    [Magnitude.LOW]: 0.10,       // 10%
    [Magnitude.MED]: 0.20,       // 20%
    [Magnitude.HIGH]: 0.35,      // 35%
    [Magnitude.CRITICAL]: 0.50,  // 50%
    [Magnitude.SEVERE]: 0.50     // 50%
} as Record<Magnitude, number>;

export const RESENTMENT_GENERATION = {
    [Magnitude.VERY_LOW]: 1,
    [Magnitude.LOW]: 3,
    [Magnitude.MED]: 5,
    [Magnitude.HIGH]: 10,
    [Magnitude.CRITICAL]: 20,
    [Magnitude.SEVERE]: 20
} as Record<Magnitude, number>;

export const INSTABILITY_GENERATION = {
    [Magnitude.VERY_LOW]: 1,
    [Magnitude.LOW]: 2,
    [Magnitude.MED]: 4,
    [Magnitude.HIGH]: 8,
    [Magnitude.CRITICAL]: 16,
    [Magnitude.SEVERE]: 16
} as Record<Magnitude, number>;
...
export function getMagnitudeValue(mag: Magnitude): number {
    switch (mag) {
        ...
        case Magnitude.MEDIUM: return 3;
        case Magnitude.HIGH: return 4;
        case Magnitude.CRITICAL: return 5;
